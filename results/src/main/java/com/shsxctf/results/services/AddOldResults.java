            ...
            if(temp.size() == 2 && temp.get(1).getElementsByAttribute("href").size() > 0) {
                ...
                if(!isUrlIdExists(tempUrl, template)) {
                    if(Scraper.getLines(tempUrl) != null && tempUrl.contains("section2harrier")) {
                        if(!tempUrl.equals("https://www.section2harrier.com/crosscountry17/xc17groutinvy.html") || tempUrl.equals("https://www.section2harrier.com/crosscountry17/xc17niskayunaekideninvy.html") || tempUrl.equals("https://www.section2harrier.com/crosscountry17/xc17queensburyinvy.html")) {
